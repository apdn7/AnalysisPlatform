...
class ConfigKey(StrEnum):
    """Config key for Flask APP"""

    INIT_LOG_DIR = 'INIT_LOG_DIR'
    INIT_BASIC_CONFIG_FILE = 'INIT_BASIC_CONFIG_FILE'
    BASIC_CONFIG_FILE = 'BASIC_CONFIG_FILE'
    START_UP_FILE = 'START_UP_FILE'
...
class Config(object):
    ...
    INIT_BASIC_CONFIG_FILE = os.path.join(INIT_CONFIG_DIR, 'basic_config.yml')

    IS_SEND_GOOGLE_ANALYTICS = True

    YAML_CONFIG_DIR = os.path.join(basedir, 'ap', 'config')
    BASIC_CONFIG_FILE = os.path.join(YAML_CONFIG_DIR, 'basic_config.yml')
    START_UP_FILE = os.path.join(BASE_DIR, 'startup.yaml')
