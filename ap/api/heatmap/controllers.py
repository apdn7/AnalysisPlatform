...
def trace_data():
    ...
    graph_context = get_graph_context_param(dic_form, EventType.HMP)
    ...
    dic_param = gen_heatmap_data(graph_context.graph_param, graph_context.dic_param, graph_context.df)
