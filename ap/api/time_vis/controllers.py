...
from ap.api.time_vis.services import gen_graph_for_time_vis
...
api_tv_blueprint = Blueprint('api_tv_module', __name__, url_prefix='/ap/api/tv')


@api_tv_blueprint.route('/plot', methods=['POST'])
def trace_data():
    """
    Trace Data API
    return dictionary
    ...
    dic_param = gen_graph_for_time_vis(graph_param, dic_param, df)
