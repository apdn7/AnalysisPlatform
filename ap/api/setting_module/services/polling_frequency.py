...
from ap import scheduler, dic_request_info
from ap.api.setting_module.services.csv_import import import_csv_job
from ap.api.setting_module.services.factory_import import import_factory_job, \
...
from ap.common.scheduler import JobType, remove_jobs, scheduler_app_context, add_job_to_scheduler
...
def add_import_job(proc_cfg: CfgProcess, interval_sec=None, run_now=None, is_user_request: bool = False):
    ...
    dic_import_param = dict(_job_id=job_id, _job_name=job_name,
                            ...
                            proc_id=proc_cfg.id, is_user_request=is_user_request)
