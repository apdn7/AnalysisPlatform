...
class ErrorTypeDetail:
    """Data class for error type details.

    This class stores information about a specific error type including
    its reason code and HTTP status code.

    Attributes:
        reason: String identifier for the error reason.
...
class ExternalErrorMessage:
    """Container class for external API error message templates.

    This class provides static error message templates and class methods
    to generate formatted error messages for various validation failures
    in the external API.

    Attributes:
        invalid_datetime_msg: Template for datetime format errors.
        invalid_id_format_msg: Template for ID format errors.
        invalid_option_id_msg: Template for invalid option ID errors.
        invalid_req_id_msg: Template for invalid request ID errors.
        invalid_latest_msg: Template for invalid 'latest' parameter errors.
        invalid_od_filter_msg: Template for invalid on-demand filter errors.
        invalid_function_msg: Template for invalid function name errors.
        unexpected_error_msg: Template for unexpected errors.
        req_duplicate_id_msg: Template for duplicate request ID errors.
        missing_field_msg: Template for missing field errors.
        out_of_range_msg: Template for out-of-range value errors.
        invalid_length_msg: Template for invalid length errors.

    Methods:
        missing_field: Generate error for missing required field.
        invalid_datetime_format: Generate error for invalid datetime format.
        invalid_id_format: Generate error for invalid ID format.
        invalid_option_id: Generate error for invalid option ID.
        invalid_req_id: Generate error for invalid request ID.
        invalid_format: Generate generic format error.
        out_of_range: Generate error for out-of-range values.
        internal_error: Generate error for internal server errors.
        invalid_odf_filter: Generate error for invalid on-demand filter.
        invalid_function_format: Generate error for invalid function name.
        length_error: Generate error for invalid parameter length.
...
class ErrorType:
    """Container class for predefined error type constants.

    This class defines standard error types used throughout the external API,
    each with an associated reason code and HTTP status code.

    Attributes:
        missing_field: Error for missing required fields (400).
        invalid_format: Error for invalid format (400).
        invalid_url: Error for invalid URL (404).
        unexpected_error: Error for unexpected server errors (500).
        id_notfound: Error for ID not found (404).
        out_of_range: Error for values out of range (422).
        duplicate_id: Error for duplicate IDs (409).
        invalid_length: Error for invalid length (422).
...
class ValidationRules:
    """Class for defining validation rules for API parameters.

    This class encapsulates validation rules that can be applied to API
    request parameters, including requirements, format constraints, and
    value ranges.

    Attributes:
        _REQUIRED: Constant for required field rule.
        _DUPLICATED: Constant for duplicate check rule.
        _FORMAT: Constant for format validation rule.
        _RANGE_VALUE: Constant for range validation rule.
        _URL: Constant for URL validation rule.
        _LIST_ALLOW: Constant for list allowance rule.
        _NOT_FOUND: Constant for not found check rule.
        _LENGTH_RANGE: Constant for length range rule.
        param_format: Format specification for the parameter.
        required: Whether the parameter is required.
        duplicate: Whether to check for duplicates.
        format: Whether to validate format.
        range_value: Whether to validate value range.
        url: Whether to validate as URL.
        list_allow: Whether to allow list of values.
        not_found: Whether to check if value exists.
    ...
    def __init__(self, rules, format=None) -> None:
...
class Validation:
    """Main validation class for external API requests.

    This class provides comprehensive validation for external API requests,
    including parameter validation, format checking, and error handling.
    It supports multiple API endpoints with different validation rules.

    Attributes:
        _REQUIRED: Constant for required field validation.
        _DUPLICATED: Constant for duplicate check validation.
        _FORMAT: Constant for format validation.
        _RANGE_VALUE: Constant for range validation.
        _URL: Constant for URL validation.
        _EXAMPLE_VALUE: Constant for example value.
        _ACCEPT_LIST: Constant for accepted values list.
        _LENGTH_RANGE: Constant for length range validation.
        _POSITIVE_INT: Constant for positive integer format.
        _STR: Constant for string format.
        _ISO_DATETIME: Constant for ISO8601 datetime format.
        _REAL: Constant for real number format.
        _ARRAY: Constant for array format.
        _SMALL_INT: Constant for small integer format.
        _LIST_ALLOW: Constant for list allowance.
        request: Request object containing parameters.
        params: Dictionary of parameter validation rules.
        formats: Format specifications.
        validate_func: List of validation functions to execute.
        api_error: APIError object for collecting errors.

    Methods:
        validate_required: Validate required parameters.
        validate_duplicated_req_id: Check for duplicate request IDs.
        validate_req_id_not_found: Check if request ID exists.
        validate_option_id_not_found: Check if option ID exists.
        validate_odf_data: Validate on-demand filter data.
        validate_format: Validate parameter formats.
        bookmark: Set up validation rules for bookmark endpoint.
        dn7: Set up validation rules for dn7 endpoint.
        fpp: Set up validation rules for FPP endpoint.
        skd: Set up validation rules for SKD endpoint.
        rlp: Set up validation rules for RLP endpoint.
        chm: Set up validation rules for CHM endpoint.
        msp: Set up validation rules for MSP endpoint.
        pcp: Set up validation rules for PCP endpoint.
        scp: Set up validation rules for SCP endpoint.
        agp: Set up validation rules for AGP endpoint.
        stp: Set up validation rules for STP endpoint.
        columns_of_processes: Set up validation for columns endpoint.
        send_a_list_options: Set up validation for sending options.
        get_list_options: Set up validation for getting options.
        save_bookmark: Set up validation for saving bookmarks.
        get_params: Set up validation for getting parameters.
        register_by_file: Set up validation for file registration.
        validate: Execute all validation functions and check for errors.
