...
from ap.api.common.services.show_graph_jump_function import get_graph_context_param, save_data_of_graph
...
def generate_agp():
    ...
    graph_context = get_graph_context_param(dic_form, EventType.AGP)
    ...
    save_data_of_graph(graph_context, org_dic_param, EventType.AGP)
