...
def backup_data_job(process_id: int, start_time: str, end_time: str, job_management: JobManagement):
    gen = backup_db_data(process_id, start_time, end_time, job_management=job_management)
...
@scheduler_app_context
def restore_data_job(process_id: int, start_time: str, end_time: str, job_management: JobManagement):
    gen = restore_db_data(process_id, start_time, end_time, job_management=job_management)
    send_processing_info(gen, job_management=job_management)
    add_gen_proc_link_job(process_id=process_id, is_user_request=True)
