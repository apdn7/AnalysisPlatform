...
def migrate_cfg_process_column(app_db):
    is_english_name_existing = app_db.is_column_existing(
        CfgProcessColumn.__table__.name, 'english_name'
    )
    ...
    is_name_local_existing = app_db.is_column_existing(
        CfgProcessColumn.__table__.name, 'name_local'
    )
    ...
    is_process_name_local_existing = app_db.is_column_existing(
        CfgProcess.__table__.name, 'name_local'
    )
