...
from ap import get_basic_yaml_obj, dic_yaml_config_file
from ap.common.common_utils import resource_path, parse_int_value
...
def check_and_convert_old_yaml():
    ...
    # current version
    cur_ver = str(basic_config_yaml.get_version())
    ...
    if not old_node_list:
        ...
        # update yaml version
        basic_config_yaml.set_version(new_ver)
        basic_config_yaml.save_yaml()
        return
