...
class DiskUsageInterface:
    """Interface for disk usage checking implementations.

    Abstract base class defining the interface for disk usage checking.
    Implementations should provide methods to retrieve disk usage information
    for different storage locations or systems.

    Methods:
        get_disk_usage: Class method to retrieve disk usage information for a given path.
