...
class AlwaysTrigger(BaseTrigger):
    ...
    def __getstate__(self) -> dict:
        """Return the state of the trigger for pickling.

        Prepares the trigger instance for serialization by returning a dictionary
        containing the trigger's configuration state.

        Returns:
            A dictionary with the 'seconds' key containing the trigger interval.
    ...
    def __setstate__(self, state) -> None:
        """Restore the trigger state from a pickled dictionary.

        Restores the trigger instance from a serialized state dictionary,
        typically called during unpickling operations.

        Args:
            state: A dictionary containing the trigger's configuration with
                the 'seconds' key specifying the trigger interval.
