...
class AcquirerProxy(BaseProxy):
    ...
    def __enter__(self) -> None:
        """Acquire the lock when entering a context manager.

        This method is called when entering a 'with' statement. It acquires
        the remote lock by invoking the 'acquire' method on the managed object
        through the multiprocessing proxy mechanism.

        Returns:
            The result of the acquire operation on the remote lock object.
    ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> Any:
        """Release the lock when exiting a context manager.

        This method is called when exiting a 'with' statement. It releases
        the remote lock by invoking the 'release' method on the managed object
        through the multiprocessing proxy mechanism. The method is called
        regardless of whether an exception occurred within the context.
        ...
        Returns:
            The result of the release operation on the remote lock object.
