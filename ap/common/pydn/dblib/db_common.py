...
class SqlComparisonOperator(Enum):
    """SQL comparison operators for building database queries.

    Defines standard SQL comparison operators used in WHERE clauses:
...
def gen_insert_col_str(column_names: Union[dict, list] | None = None):
    """
...
def gen_select_col_str(column_names: Union[dict, list] | None = None, is_add_double_quote=True):
    """
    Add double quotes to each name of column existing in model columns and combine to string
    :param column_names:
