...
class MSSQLServer:
    """Microsoft SQL Server database connection and operations handler.

    Provides methods for connecting to and interacting with MS SQL Server databases,
    ...
    Attributes:
        ...
        schema: Optional schema name for queries.
    ...
    def __init__(self, host, dbname, username, password, port=1433, read_only=False) -> None:
        self.host = host
        self.port = port
        self.dbname = dbname
