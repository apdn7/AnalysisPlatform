...
class ProcConfigYaml(YamlConfig):
    """
...
class Hist2ConfigYaml(YamlConfig):
    """
    ...
    def __init__(self, fname_config_yaml=None):
        if fname_config_yaml:
            ...
            super().__init__(dic_yaml_config_file[YAML_CONFIG_AP])
...
class TransformYamlToDb:
    ...
    def is_yaml_config_exists():
        ...
        """
        yaml_keys = [YAML_CONFIG_BASIC, YAML_CONFIG_DB, YAML_CONFIG_PROC, YAML_CONFIG_AP]
    ...
    def import_to_db(self):
        ...
        for ds_id in data_sources:
            ...
            for proc_id, proc_new_id in dic_procs.items():
                ...
                auto_incremental_col = self.ap_yaml.get_auto_increment_col(proc_id)
                ...
                dic_chart_infos = {}
                filters = self.ap_yaml.get_all_filters(proc_id) or {}
    ...
    def set_machine_filter(self, machine_info, filter_cfg: CfgFilter):
        if not machine_info:
            return None
