...
class PullSoftwareWorkshopHistory(PullSoftwareWorkshop):
    """Pulls historical data from Software Workshop databases.

    Specialized implementation for extracting history table data from Software Workshop.

    Methods:
        get_min_max_factory_datetime_per_process_query: Gets min/max time query for history data.
        get_transaction_data_query: Builds query for history transaction data.
